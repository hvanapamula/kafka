...
public class KafkaConfig {
	...
	public ConsumerFactory<String, String> consumerFactory() {
		...
		configMap.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, Constants.KAFKA_LOCAL_SERVER_CONFIG);//line-23
		...
		configMap.put(ConsumerConfig.GROUP_ID_CONFIG, Constants.GROUP_ID_STRING);//line-26
